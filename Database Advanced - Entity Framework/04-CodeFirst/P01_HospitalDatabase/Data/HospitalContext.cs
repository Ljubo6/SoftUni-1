namespace P01_HospitalDatabase.Data
{
    ...
    public class HospitalContext : DbContext
    {
        ...
        private static void ConfigurePatientMedicamentEntity(ModelBuilder modelBuilder)
        {
            modelBuilder
        ...
        private static void ConfigureMedicamentEntity(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<Medicament>()
        ...
        private static void ConfigureVisitationEntity(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<Visitation>()
        ...
        private static void ConfigureDiagnoseEntity(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<Diagnose>()
